...
import { Save, Bell, Shield, Users, Zap, Globe, Database, RefreshCw } from "lucide-react";
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    id="companyName"
                    defaultValue="Arible Estate & Property"
                  />
                </div>
                <div className="space-y-2">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-warning/10 rounded-lg border border-warning/20">
                <p className="text-sm text-warning">
                  ...
                  {INSTALLMENT_INTEREST_RATE * 100}% interest is applied every 3
                  months on outstanding balance
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="space-y-2 flex items-end ">
                  <button type="button" className="px-6 py-2 rounded-md bg-blue-400 text-white hover:bg-blue-500 transition-colors">
